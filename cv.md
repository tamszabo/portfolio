...
<div class="flex justify-between items-center mb-10 pb-4 border-b border-[#2a2a2a]">
    <h1 class="text-3xl font-black text-white uppercase tracking-tighter">
        Tamas <span class="text-[#3c6e71]">Szabo</span>
    </h1>
    <a href="{{ '/assets/tamas-szabo-cv.pdf' | relative_url }}" download
       class="text-xs font-bold uppercase tracking-widest text-[#8a9a9b] hover:text-[#4a8e91] transition border border-[#2a2a2a] px-4 py-2 rounded-lg">
        ↓ Download PDF
    </a>
</div>
...
<section class="space-y-12">
    ...
    <div class="relative pl-14">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-baseline mb-1">
            ...
            <span class="text-sm font-mono text-[#8a9a9b]">10/2023 — 07/2025</span>
        </div>
        <p class="text-[#4a8e91] text-sm font-semibold mb-3 italic">Senior Data Analyst | Frankfurt am Main, Germany</p>
    ...
    <div class="relative pl-14">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-baseline mb-1">
            ...
            <span class="text-sm font-mono text-[#8a9a9b]">12/2019 — 09/2023</span>
        </div>
        <p class="text-[#4a8e91] text-sm font-semibold mb-3 italic">Data Analyst | Budapest, Hungary</p>
        <ul class="list-disc list-outside ml-4 space-y-2 text-[#b0bfc0] text-sm">
    ...
    <div class="relative pl-14">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-baseline mb-1">
            ...
            <span class="text-sm font-mono text-[#8a9a9b]">07/2017 — 11/2019</span>
        </div>
        <p class="text-[#4a8e91] text-sm font-semibold mb-3 italic">Business Intelligence Analyst | Budapest, Hungary</p>
        <ul class="list-disc list-outside ml-4 space-y-2 text-[#b0bfc0] text-sm">
    ...
    <div class="relative pl-14">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-baseline mb-1">
            ...
            <span class="text-sm font-mono text-[#8a9a9b]">01/2017 — 06/2017</span>
        </div>
        <p class="text-[#4a8e91] text-sm font-semibold mb-3 italic">Fraud Risk Analyst Trainee | Budapest, Hungary</p>
        <ul class="list-disc list-outside ml-4 space-y-2 text-[#b0bfc0] text-sm">
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-12 mt-20 pt-10 border-t border-[#2a2a2a]">
    <section>
        <h2 class="text-xs font-black uppercase tracking-[0.2em] text-[#3c6e71] mb-6">Technical Skills</h2>
        <div class="space-y-4">
            <div>
                <h4 class="text-white text-sm font-bold mb-1 text-[#6aacaf]">Data Visualization</h4>
                <p class="text-[#b0bfc0] text-sm">Tableau <span class="text-[#4a8e91] font-semibold">(Desktop Specialist Certified)</span>, Power BI, QlikSense</p>
            </div>
            <div>
                <h4 class="text-white text-sm font-bold mb-1 text-[#6aacaf]">Data Analysis</h4>
                <p class="text-[#b0bfc0] text-sm">SQL, Advanced Excel, KPI Framework Development</p>
            </div>
            <div>
                <h4 class="text-white text-sm font-bold mb-1 text-[#6aacaf]">Soft Skills</h4>
                <p class="text-[#b0bfc0] text-sm">Stakeholder Management, Mentoring, Cross-functional Collaboration, Workshop Facilitation</p>
            </div>
            <div>
                <h4 class="text-white text-sm font-bold mb-1 text-[#6aacaf]">Languages</h4>
                <p class="text-[#b0bfc0] text-sm">Hungarian (Native), English (Fluent — C1), German (Beginner — A2)</p>
            </div>
        </div>
    </section>
    <section class="space-y-8">
        <div>
            <h2 class="text-xs font-black uppercase tracking-[0.2em] text-[#3c6e71] mb-4">Education</h2>
            <h3 class="text-white font-bold text-sm">BSc in Mathematics</h3>
            <p class="text-[#8a9a9b] text-xs italic">Eötvös Loránd University | 2016</p>
        </div>
        <div>
            <h2 class="text-xs font-black uppercase tracking-[0.2em] text-[#3c6e71] mb-4">Certificates</h2>
            <div class="flex items-center gap-3 bg-[#252525]/50 p-3 rounded-lg border border-[#2a2a2a]">
